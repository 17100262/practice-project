...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference('Discipline.count') do
      post disciplines_url, params: { discipline: { Description: @discipline.Description, Name: @discipline.Name } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { Description: @discipline.Description, Name: @discipline.Name } }
